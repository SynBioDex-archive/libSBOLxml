 ...
 *       &lt;sequence>
 *         &lt;element name="subComponent" type="{}DnaComponentImpl" maxOccurs="unbounded" minOccurs="0"/>
...
public class SequenceAnnotationImpl {
    ...
    protected List<DnaComponentImpl> subComponent;
     ...
     * 
     */
    public List<DnaComponentImpl> getSubComponent() {
        if (subComponent == null) {
            subComponent = new ArrayList<DnaComponentImpl>();
        }
