 ...
 *         &lt;element name="annotations" type="{}SequenceAnnotationImpl" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class DnaComponentImpl {
    ...
    protected List<SequenceAnnotationImpl> annotations;
     ...
     * 
     */
    public List<SequenceAnnotationImpl> getAnnotations() {
        if (annotations == null) {
            annotations = new ArrayList<SequenceAnnotationImpl>();
        }
